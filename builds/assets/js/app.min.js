(function (factory) {
	...
	*/
	...
	(function ($) {
	  function appScript() {
	    var rtlPage = $("html").attr("dir") == "rtl" || $("html").attr("lang") == "ar" ? true : false;
	    ...
	    (function () {
	      ...
	      $("[data-toggle='menu']").on("click", function (e) {
	        ...
	        if (rtlPage) {
	          $(dataTarget + " .app-menu__offcanvas").animate({
	            right: 0
	          }, 400);
	        } else {
	          $(dataTarget + " .app-menu__offcanvas").animate({
	      ...
	      $("[data-dismiss='menu']").on("click", function (e) {
	        ...
	        if (rtlPage) {
	          getMenu.find(".app-menu__offcanvas").animate({
	            right: -menuW
	          }, 400);
	        } else {
	          getMenu.find(".app-menu__offcanvas").animate({
	      ...
	      $(".app-menu").on("click", function (e) {
	        ...
	        if (rtlPage) {
	          $(this).find(".app-menu__offcanvas").animate({
	            right: -menuW
	          }, 400);
	        } else {
	          $(this).find(".app-menu__offcanvas").animate({
	      ...
	      $(document).keydown(function (e) {
	        if (e.keyCode == 27) {
	          ...
	          $(".app-menu .app-menu__offcanvas").animate({
	            left: -menuW
	          }, 400);
	          $(".app-menu").fadeOut();
	    ...
	    (function () {
	      $("[data-form]").on("click", function (e) {
	        ...
	        $(this).parents(".app-modal-container").find("." + thisELe + "-auth-form").show();
	      });
	    })();
	...
	window.addEventListener("DOMContentLoaded", function () {
	  (function () {
	    ...
	    // Property Gallery
	    new Swiper$1(".single-property-gallery .swiper", {
	      slidesPerView: 1,
	      speed: 800,
	      autoplay: {
	        delay: 2500
	    ...
	    // Properties Slides
	    new Swiper$1(".properties-carousal .swiper", {
	      speed: 800,
	      spaceBetween: 20,
	      autoplay: {
	        delay: 5000
	    ...
	    // Partners Slides
	    new Swiper$1(".partners-section .swiper", {
	      speed: 800,
	      spaceBetween: 20,
	      autoplay: {
	        delay: 5000
	    ...
	    (function () {
	      ...
	      Steps = class Steps {
	        constructor(div) {
	          ...
	          this.parsley = jquery(this.div).parsley();
	          this.currentIdx = 0;
	          this.setupActions();
	          this.toggleButtons();
	          return;
	      ...
	      Step = class Step {
	        constructor(parent, el, index) {
	          ...
	          jquery(this.el).find(".form-control, .form-select").attr("data-parsley-group", "block-" + index);
	          // $(this.el)
	          //   .find("select")
